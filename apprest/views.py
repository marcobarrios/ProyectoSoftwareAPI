...
from apprest.serializers import ContactoSerializer, DetalleListaContactoSerializer, ListaContactoSerializer, \
    TipoTelefonoSerializer, TelefonoSerializer, EventoSerializer
